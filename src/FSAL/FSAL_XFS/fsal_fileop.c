                                   ...
                                   fsal_attrib_list_t * file_attributes /* [ IN/OUT ] */ )
{
  ...
  fsal_status =
      XFSFSAL_lookup((fsal_handle_t *)dirhandle, filename, p_context,  (fsal_handle_t *)&filehandle, file_attributes);
  if(FSAL_IS_ERROR(fsal_status))
    return fsal_status;

  return XFSFSAL_open((fsal_handle_t *)&filehandle, p_context, openflags, file_descriptor,
                      file_attributes);
}
